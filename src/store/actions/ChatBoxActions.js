...
CHAT_BOX_NOTIFICATION_CUSTOMERID
} from "../ActionTypes";
...
export const setChatBoxNotificationCustomerId = (chatBoxNotificationCustomerId) =>{
  return {
    type: CHAT_BOX_NOTIFICATION_CUSTOMERID,
    payload: {
      chatBoxNotificationCustomerId: chatBoxNotificationCustomerId,
    },
  };
}
...
export const setSmsChatListData = (smsChatListData) => {
  return {
    type: SMS_CHAT_LIST_DATA,
    payload: {
      smsChatListData: smsChatListData,
    },
  };
};
