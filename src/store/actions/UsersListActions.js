...
export const setUsersListDatas = (usersListDatas,pageNumber) => {
  return {
    type: USERS_LIST_DATAS,
    payload: {
      usersListData: usersListDatas,
      page: pageNumber
    },
  };
};
export const setAgentsListData = (agentsListData) => {
  return {
