...
export const ChatBoxReducer = (
  ...
  switch (action.type) {
    ...
    case CHAT_BOX_RECENT_SEARCH_TEXT:
      ...
      case CHAT_BOX_NOTIFICATION_CUSTOMERID:
        return Object.assign({}, state, {
          chatBoxNotificationCustomerId: action.payload.chatBoxNotificationCustomerId,
        });
      ...
      case SMS_CHAT_LIST_DATA:
        return Object.assign({}, state, {
          smsChatListData: action.payload.smsChatListData,
        });
