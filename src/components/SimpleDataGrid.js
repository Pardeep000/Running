...
const altRowBackgroundColor = "#efefef";
...
export const SimpleDataGrid = (props) => {
  ...
  const tableIcons = {
    ...
    ResetSearch: forwardRef((props, ref) => <Clear  style={{color:"#777777"}} {...props} ref={ref} />),
    Search: forwardRef((props, ref) => <Search style={{color:"#777777",borderBottom:'#777777'}} {...props} ref={ref} />),
