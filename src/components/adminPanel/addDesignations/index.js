...
const AddDesignations = (props) => {
  ...
  useEffect(() => {
    ...
    if(!props.alldesignationdata.length){
  ...
  useEffect(()=>{
    ...
    if(getDesignationsQueryResult && getDesignationsQueryResult.designations){

        props.setAllDesginationData(getDesignationsQueryResult.designations);
    }
