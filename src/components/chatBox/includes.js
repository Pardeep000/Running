...
export default class includes {
  ...
  getEmptyUsersListMessage(authPanelType, usersListSelectedUser) {
    if (authPanelType == PanelType.MANAGER && !usersListSelectedUser)
      return "No user selected.";
    else if (authPanelType == PanelType.SUPERADMIN && !usersListSelectedUser){return "loading..."}
  ...
  bindItemToMainChat(
    ...
    setChatBoxMarkNotToAddInChatCircleForLabel(item.marknottoaddinchatcircle);
  }
