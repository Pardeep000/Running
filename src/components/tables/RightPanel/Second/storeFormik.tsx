...
`;
  ...
  //   pname: Yup.string().required('Email is required'),
  ...
  //   oldpass: Yup.string().min(3, 'Password must be at least 3 characters').required('Email is required'),

  //   newpass: Yup.string().min(3, 'Password must be at least 3 characters').required('Email is required'),

  //   conpass: Yup.string().min(3, 'Password must be at least 3 characters').required('Email is required'),

  //   chatlimit: Yup.string().required('Email is required'),
  // })
  ...
  //   console.log(values)
  //   setSubmitting(false)
  //   console.log('form is submitted here...')
  // }
  ...
  const handleSubmitt = (values: any, { setSubmitting }: FormikHelpers<any>) => {
    ...
    <>
      ...
      >
        {({ errors, touched, isSubmitting }) => (
          <Form onSubmit={(event) => {
            event.preventDefault();
            console.log("formik submitting from other place")
          }}>
            <Field
              name="email"
              as={TextField}
